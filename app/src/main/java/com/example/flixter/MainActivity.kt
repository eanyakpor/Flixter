...
private lateinit var rvMovies: RecyclerView
    /*
    1.Define a data model class at the data source -DONE
    ...
    5.Bind the adapter to the datasource to populate the RecylerView - DONE
    6.Bind a layout manger to the recycler view
    */
        ...
        client.get(NOW_PLAYING_URL, object: JsonHttpResponseHandler(){
            ...
            override fun onSuccess(statusCode: Int, headers: Headers?, json: JSON) {
                ...
                try{
                    ...
                    //developer can see in the logcat that something has gone wrong.
